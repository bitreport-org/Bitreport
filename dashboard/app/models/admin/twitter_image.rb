module Admin
  class TwitterImage < ApplicationRecord
    SYMBOLS = %w[STRATBTC EDOUSD ZCLBTC LENDBTC XELBTC PASCBTC PINKBTC IOTBTC DATUSD EMC2BTC SHIFTBTC ETCBTC SCBTC NEOBTC XRPUSD BTCUSD SANUSD ZECUSD ZECBTC TRUSTBTC EOSBTC LTCUSD].freeze
